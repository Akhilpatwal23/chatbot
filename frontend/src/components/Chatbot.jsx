...
const Chatbot = () => {
  ...
  return (
    <Box sx={{ margin: 0, padding: 0, textAlign: "center", backgroundColor: darkMode ? "#333" : "#fff", color: darkMode ? "#fff" : "#333", width: "100vw", height: "100vh" }}>
      <Typography variant="h4" sx={{ color: darkMode ? "#fff" : "#333" }}>
        AI Chatbot
      </Typography>
      <Typography variant="body1" sx={{ marginTop: 1, marginBottom: 1, color: darkMode ? "#ccc" : "#666" }}>
      ...
      >
          ...
          {conversation.map((entry, index) => (
            <Paper
              ...
              sx={{
                ...
                backgroundColor: entry.role === "user" ? (darkMode ? "#007bff" : "#007bff") : (darkMode ? "#333" : "#f1f1f1"),
                color: entry.role === "user" ? "white" : (darkMode ? "#fff" : "#333"),
                display: "flex",
                flexDirection: "row",
                alignItems: "center",
              }}
        ...
        >
          ...
          >
            {mutation.isLoading ? (
              <CircularProgress size={24} style={{ color: darkMode ? "#fff" : "white" }} />
            ) : (
              <IoSend />
            )}
          </IconButton>
